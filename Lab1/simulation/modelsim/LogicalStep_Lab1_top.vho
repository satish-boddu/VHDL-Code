...
SIGNAL \inst5|auto_generated|cmpr1|aneb_result_wire[0]~5_combout\ : std_logic;
...
SIGNAL \inst5|auto_generated|cmpr1|aneb_result_wire[0]~6_combout\ : std_logic;
SIGNAL \inst5|auto_generated|cmpr1|aneb_result_wire[0]~7_combout\ : std_logic;
SIGNAL \inst5|auto_generated|cmpr1|aneb_result_wire[0]~8_combout\ : std_logic;
SIGNAL \inst5|auto_generated|counter_comb_bita27~COUT\ : std_logic;
SIGNAL \inst5|auto_generated|counter_comb_bita27~0_combout\ : std_logic;
...
SIGNAL \inst10|XOR_OUT~combout\ : std_logic;
SIGNAL \inst10|OR_OUT~combout\ : std_logic;
SIGNAL \inst10|NAND_OUT~combout\ : std_logic;
SIGNAL \inst5|auto_generated|counter_reg_bit\ : std_logic_vector(27 DOWNTO 0);
SIGNAL \inst10|ALT_INV_NAND_OUT~combout\ : std_logic;
...
\inst10|ALT_INV_NAND_OUT~combout\ <= NOT \inst10|NAND_OUT~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst10|ALT_INV_NAND_OUT~combout\,
	devoe => ww_devoe,
	o => \leds[5]~output_o\);
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~5\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~6\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~7\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cmpr1|aneb_result_wire[0]~8\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|counter_comb_bita27~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst5|auto_generated|cout_actual\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst10|XOR_OUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst10|OR_OUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\inst10|NAND_OUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
